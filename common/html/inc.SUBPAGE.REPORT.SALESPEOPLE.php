...
?>
									...
									<div id="control_window" name="control_window" style="z-index: 2; position: relative; top: 20px; left: 0px; width: 960px; height: 100px; border: 0px solid #fff; margin-bottom: 5px;">
										<?
                 			// controls ----------------------------------------
	                 		require('/var/www/vhosts/'.$_SERVER['SERVER_NAME'].'/httpdocs/common/html/control/inc.CONTROL.SALES_transactions.php');
										?>
									</div>
									<!-- END controls -->
                 	...
                 	<?
                 		// chart -----------------------------------------
	                 	require('/var/www/vhosts/'.$_SERVER['SERVER_NAME'].'/httpdocs/common/html/chart/inc.CHART.SALES_transactions.php');
  	               ?>
									</div>
									<!-- END chart window -->
									...
									<a href="javascript:SM_PDF_Report('form_sales_currentmonth', 'salesman_current_month_all_records');" style="position: absolute; top: 585px; right: 22px; z-index: 100;">Generate PDF Spreadsheet</a>



									<!-- report/spreadsheet HTML window -->
									<div id="salesman_current_month_all_records.report" style="z-index: 2; position: relative; top: 20px; left: 0px; width: 960px; height: auto; min-height: 200px; border: 0px solid #f00; margin-bottom: 20px;">
									</div>
									...
									<? 
										...
										echo 'SM_Report_Update(\'form_sales_currentmonth\', \'salesman_current_month_all_records.report\', \'ts_sold:asc\');';
									?>
									</script>
