...
?>
									...
									<!-- controls -->
									<div id="control_window" name="control_window" style="z-index: 2; position: relative; top: 0px; left: 0px; width: 960px; height: 180px; border: 0px solid #fff; margin-bottom: 5px;">
										<?
                 			// controls ----------------------------------------
                 	...
                 	<?
                 		// chart -----------------------------------------
	                 	require('/var/www/vhosts/'.$_SERVER['SERVER_NAME'].'/httpdocs/common/html/chart/inc.CHART.EXECUTIVE_transactions.php');
  	               ?>
									</div>
									<!-- END chart window -->
