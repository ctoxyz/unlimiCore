               			...
               			<select name="form_team_currentmonth.manager_current_month_all_records.date_start_day" id="form_team_currentmonth.manager_current_month_all_records.date_start_day" onchange="SM_Report_Update('form_team_currentmonth', 'manager_current_month_all_records.report', 'ts_sold:desc'); SM_Chart_Update('form_team_currentmonth', 'manager_current_month_all_records.chart', 'ts_sold:desc', 'manager_current_month_all_records.chart');" class="formControl_inputSelect" tabindex="2">
               				...
               				<option id="form_team_currentmonth.manager_current_month_all_records.date_start_day-31" value="31">31</option>
          			   		...
          			   		<select name="form_team_currentmonth.manager_current_month_all_records.date_start_year" id="form_team_currentmonth.manager_current_month_all_records.date_start_year" onchange="SM_Report_Update('form_team_currentmonth', 'manager_current_month_all_records.report', 'ts_sold:desc'); SM_Chart_Update('form_team_currentmonth', 'manager_current_month_all_records.chart', 'ts_sold:desc', 'manager_current_month_all_records.chart');" class="formControl_inputSelect" tabindex="3">
											 <option value="2014" id="form_team_currentmonth.manager_current_month_all_records.date_start_year-2014" <? echo (date('Y',time()) == '2014'?'selected':''); ?>>2014</option>
											 <option value="2013" id="form_team_currentmonth.manager_current_month_all_records.date_start_year-2013" <? echo (date('Y',time()) == '2013'?'selected':''); ?>>2013</option>
											 <option value="2012" id="form_team_currentmonth.manager_current_month_all_records.date_start_year-2012" <? echo (date('Y',time()) == '2012'?'selected':''); ?>>2012</option>
											 <option value="2011" id="form_team_currentmonth.manager_current_month_all_records.date_start_year-2011" <? echo (date('Y',time()) == '2011'?'selected':''); ?>>2011</option>
              				 <option value="2010" id="form_team_currentmonth.manager_current_month_all_records.date_start_year-2010" <? echo (date('Y',time()) == '2010'?'selected':''); ?>>2010</option>
              				 <option value="2009" id="form_team_currentmonth.manager_current_month_all_records.date_start_year-2009" <? echo (date('Y',time()) == '2009'?'selected':''); ?>>2009</option>
              				 <option value="2008" id="form_team_currentmonth.manager_current_month_all_records.date_start_year-2008" <? echo (date('Y',time()) == '2008'?'selected':''); ?>>2008</option>
               			</select>
            				</td>
            			</tr>
           		</table>
