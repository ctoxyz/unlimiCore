...
this.parent({});
this.img_close=this.root_dir+"../../img/icons/icon_20x20_redx.png";
AJS.update(this,_24);
...
AJS.preloadImages(GB_ROOT_DIR+"../../img/icons/icon_20x20_redx.png");
...
AJS.preloadImages(GB_ROOT_DIR+"../../img/icons/icon_20x20_redx.png",GB_ROOT_DIR+"header_bg.gif");
