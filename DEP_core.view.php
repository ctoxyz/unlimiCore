  ...
  switch ($_GET['_function']){
        	...
        	case "modal.user.login":
                ...
                ?>
                  ...
                  function helpdesk(){
                  	parent.parent.location="http://sm0002.com/helpdesk";
                  }
        		...
        		require('common/html/html-subpage-base-header.php');
						// -----------------------------------------------------------------
  						...
  						if($obj_Member->MemberAuthorized == true && $obj_Member->ModuleAuthentication($_SESSION['ActiveUser']['userid'], $_SERVER['REQUEST_URI']) == true){
								...
								echo '<div style="position: relative; left: 10px; top: 10px; margin-bottom: 10px; color: #ffffff; font-size: 25px; font-weight: bold;"><font color="#a3f59b">jm</font><font color="#00d2ff">CRM</font>&trade; System Configuration</div>';


								$importXML			= '/var/www/vhosts/sm0002.com/httpdocs/common/xml/SampleDataSet_R2.xml';
...
*/
      ...
      -->
                    ...
                    <style>
                        ...
                        /* background: 			url(http://sm0002.com/common/img/backgrounds/bg_gradient_red2blk.gif) #b11100 repeat-x fixed top center; */
                        /* background: 				url(http://sm0002.com/common/img/backgrounds/profile/female-1.jpg) #fffff no-repeat fixed top center; */

                        /*
                        background-color:				#ffffff;
                        background-image: 			url('http://sm0002.com/common/img/backgrounds/profile/female-4.jpg');
                    			...
                    			<div id="desires_panel">
                         		...
                         		<table border="0">
                               		...
                               		<table border="0" width="340">
                                 		<tr>
                                   		<td width="100" valign="top">
                                   			<font class="typeblack16pt">Fantasy</font>
                                   		</td>
                                   		<td>
																				<font class="typeblue13px"><? echo $obj_Member->RandomAnswersForEmpties($MemberProfile['fantasy'], 'generic'); ?></font>
                                   		</td>
                               			</tr>
                               		</table>
      														<!-- END domestic skills -->
                               		...
                               		<table border="0" width="340">
                                 		<tr>
                                   		<td width="100" valign="top">
                                   			<font class="typeblack16pt">Turn-Ons</font>
                                   		</td>
                                   		<td>
																				<font class="typeblue13px"><? echo $obj_Member->RandomAnswersForEmpties($MemberProfile['turnon'], 'generic'); ?></font>
                                   		</td>
                               			</tr>
                               		</table>
      														<!-- END domestic skills -->
  						...
  						// Registered & NOT Paid -------------------------------------------
  							...
  							require('common/html/html-subpage-base-header.php');
								...
								$ProfileOwner_MemberID	=	$_GET['_898a8as'];
									...
									echo '<script>';
									echo 'window.location="https://sm0002.com/Upgrade-'.$ProfileOwner_MemberID.'";';
									echo '</script>';
        						...
        						<center>
        							...
        							<? 
                               		...
                               		<table border="0" width="340">
                                 		<tr>
                                   		<td width="100" valign="top">
                                   			<font class="typeblack16pt">Fantasies</font>
                                   		</td>
                                   		<td>
																				<font class="typeblue13px"><? echo $obj_Member->RandomAnswersForEmpties($MemberProfile['fantasy'], $Type = 'profile_feature'); ?></font>
                                   		</td>
                               			</tr>
                               		</table>
      														<!-- END fantasy -->
                               		...
                               		<table border="0" width="340">
                                 		<tr>
                                   		...
                                   		<td>
																				<font class="typeblue13px"><? echo $obj_Member->RandomAnswersForEmpties($MemberProfile['turnon'], $Type = 'profile_feature'); ?></font>
                                   		</td>
                               			</tr>
                               		</table>
      														<!-- END turn ons -->
                    			...
                    			<table border=0 width="100%" height="100%">
                    				...
                    				<tr>
                          			...
                          			<table border=0 width="100%" height="100%">
                          				...
                          				<tr>
                          					<td> <input type="checkbox" class="genericsubmit18px" id="search_into_sex" name="" value="1" <? echo (strpos($__LastSearch[3],'1',2) == '2' ? 'checked':''); ?> onclick="search_UTILITY();" /></td> <td><font color="white">Sex</font></td>
                          				...
                          				<tr>
                          					<td> <input type="checkbox" class="genericsubmit18px" id="search_into_fetish" name="" value="1" <? echo (strpos($__LastSearch[3],'1',4) == '4' ? 'checked':''); ?> onclick="search_UTILITY();" /></td> <td><font color="white">Fetish</font></td>
                          				</tr>
                          			</table>
                          			<!-- options -->
													...
													if($NewUpgrade_Referrer){
														?>
															<div style="position: absolute; top: 300px; left: 250px; border: 1px solid #828282; width: 200px; height: 180px; background-color: #000000;">
																<?
																	echo "<input id=\"continue\" class=\"generic\" type=\"submit\" value=\"View Profile\" onclick=\"location='http://sm0002.com/ViewProfile-".$NewUpgrade_Referrer."'\">";
																	?>
														...
														?>
															<div style="position: absolute; top: 300px; left: 250px; border: 1px solid #828282; width: 200px; height: 180px; background-color: #000000;">
																<?
																	echo "<input id=\"continue\" class=\"generic\" type=\"submit\" value=\"Continue\" onclick=\"location='http://sm0002.com/MyHome'\">";
																?>																
															</div>
														<?
													}
							...
							// Registered & NOT Paid ---------------------------------------
  							...
  							flush();
								...
								<script type="text/javascript">
									...
									GB_showCenter('', 'http://sm0002.com/ResendActivationRequest', 180, 600);
								</script>
								<?
  							//sleep(2);
                ...
                ?>
                    ...
                    <style>
                    	...
                    	<div id="topcontainer" style="background: url(/common/img/backgrounds/bg_gradient_lightblue2blk-mystuff.gif);">
                    		...
                    		<!-- <div id="webpageaddress" ><h3 style="color: black;">Your Web Page Address: <a href="http://sm0002.com/<? echo $_SESSION['ActiveUser']['username']; ?>">sm0002.com/<? echo $_SESSION['ActiveUser']['username']; ?></a></h3></div> -->
                    ...
                    <!-- mail bins COMPLETE -->
      							...
      							<!-- promotion -->
                    					...
                    					<tr>
                    						...
                    						<a href="http://sm0002.com/mystuff"><img src="/common/img/promotional/conversation-it-starts-everything.jpg" border="0"></a>
                    							<!--
                    							<font color=white>
                    								-- promotional banner ad --
                    								<br><br><br><br>
                    								
                    								"bootyCatchers"<br> - Mail AddOns Here<br>
                    								
                    								No Mail? Are You Advertising Yourself?<br>
                    								It Takes Bling to Make 'em Sing!<br>
                    								<br><br>
                    								Are you putting yourself "out there"?
                    								<br><br>
                    								Add Some Bling & Get Noticed!
                    								<br><br>
                    								You Know how it is.. the guy with the flashy car gets noticed, and usually the chic.
                    								<br><br>
                    								So why not you?
                    								<br><br>
                    								All it takes is a little Bling & Whamo!
                    								<br><br>
...
*/
                    ...
                    ?>
                				...
                				<div id="pBuilder_editTools" style="position: absolute; top: 0px; right: 0px; border: solid 1px #434343; width: 500px; height: 350px;">
                  				...
                  				<div id="pBuilder_editTools_promotionsList" style="position: relative; top: 50px; left: 12px; border: solid 0px #ffffff; width: 470px; height: auto;">
                               	...
                               	<?
                               		...
                               		//$__AffiliatesPromos = $obj_Member->GetAffiliatePromos($MemberUserID);  MOVED TO >> LINE 934 OF topnav.php
                               	...
                               	?>
                                         ...
                                         foreach($__AffiliatesPromos as $key){
                                         	...
                                         	$_PromoID			=	$obj_Member->Encrypt($key['promoid'], 'private', 'sm0002.com');
                                         	...
                                         	switch($_Property){
                                     			...
                                     			?>
                                   					<table border="1" cellpadding="2" cellspacing="0" bgcolor="<? echo $fgbg; ?>">
                                   						<tr>
                                   							<td width="135" align="left"><a href="http://sm0002.com/MyPromos-EDIT-<? echo $_PromoID; ?>" style="color: #ffffff; font-size: 12px; text-decoration: none;"><? echo ucwords($_Property).'-'.ucwords($_PromoClass).'-'.ucwords($_Level); ?></a></td>
                      			...
                      			<div id="pBuilder_editTools_titles11" style="position: absolute; z-index: 5; top: 0px; left: 860px; border: solid 0px #ffffff; width: 80px; height: 20px; font-size: 12px; font-weight: bold; color: #ffffff; text-align: left; padding-left: 3px;">
                               	...
                               	?>
                                         ...
                                         foreach($__AffiliatesPromos as $key){
                                         	...
                                         	$_Property						=	$key['propertyid'];
                                         	$_ThumbsNum						=	$key['thumbs_num'];
                                         	$_PromoID_ENCRYPTED		=	$obj_Member->Encrypt($key['promoid'], 'private', 'sm0002.com');
                      ...
                      // ========================
                      /*
                      	include "/var/www/vhosts/sm0002.com/httpdocs/common/class/libchart/classes/libchart.php";
                      	
                      	
                      	
                      	$chart = new LineChart(700, 350);
                      ...
                      $dataSet = new XYSeriesDataSet();
                      	...
                      	$chart->render("/var/www/vhosts/sm0002.com/httpdocs/common/class/libchart/generated/demo1.png");
                      	*/
               			?>
 <!-- <img src="http://sm0002.com/common/class/libchart/generated/demo1.png"> -->
               		</div>
        				<?
...
<!--
                         		<table border="0">
                           		...
                           		<tr>
                             		<td></td>
                             		<td width="5"></td>
                             		<td>2.) To Create a Geo Promo Ad simply go to <a href="http://sm0002.com/MyPromos">Create Ad</a> & click on the "Create New" button
                             		</td>
                         			</tr>
...
<!--
                         		<table border="0">
                           		...
                           		<tr>
                             		<td></td>
                             		<td width="5"></td>
                             		<td>2.) To Create a Banner Promo Ad simply go to <a href="http://sm0002.com/MyPromos">Create Ad</a> & Scroll Down to Banner Promo Ads
                             		</td>
                         			</tr>
...
<!--
                         		<table border="0">
                           		...
                           		<tr>
                             		<td></td>
                             		<td width="5"></td>
                             		<td>1.) The <a href="http://sm0002.com/Payments">Earnings</a> page is a shows all UNPAID Earnings per Ad Promo
                             		</td>
                         			</tr>
...
-->
        	...
        	case "member-Authenticate":
                ...
                ?>
          			...
          			<!-- core css -->
          			<link rel="stylesheet" type="text/css" href="http://sm0002.com/common/css/base.css" />
...
-->
        ...
        ?>
					<!-- html  -->
						<center>
							<br><br><br><br>
							<font class="greetinglarge">§2257 Exemption Statement sm0002.com</font>
							<br><br><br>
							<font color="white">
...
<!--										
                  ...
                  <table width="100%" height="100%">
                  	<tr>
                  		<td align=middle>><img src="http://sm0002.com/common/img/logo/pub.logo.friendsnflings-com.jpg" alt="FriendsNFlings.com" border="0" style="cursor: pointer;" onclick="PreRegQuickSearch('women');" /></td>
                  		<td width="50"></td>
                  		<td align=middle><a href="http://qualitymen.com" target="_new"><img src="http://sm0002.com/common/img/logo/pub.logo.qualitymen-com.jpg" alt="QualityMen.com" border=0 /></a></td>
                  	</tr>
              
                  	<tr>
                  		<td align=middle><a href="http://hardbodysingles.com" target="_new"><img src="http://sm0002.com/common/img/logo/pub.logo.hardbodysingles-com.gif" alt="HardBodySingles.com" border=0 /></a></td>
                  		<td width="50"></td>
                  		<td align=middle><img src="http://sm0002.com/common/img/logo/pub.logo.in-development.gif" alt="In Development" border=0 /></td>
                  	</tr>
                  </table>
-->
...
<!--
          						<div id="_promo_title" style="position: absolute; top: 250px; right: 19px; width: 385px; height: 375px; border: 1px solid #ff0000; border-style: dashed; text-align: center; background-color: #000000;">
												...
												<br>
												<img src="http://sm0002.com/common/img/logo/pub.logo.friendsnflings-com.jpg" alt="FriendsNFlings.com" border="0" style="cursor: pointer;" onclick="alert('signup_FNF_Affiliate');" />
												<br>
												<table border="0" width="100%">
													<tbody>
...
<?
									...
									case 2:
										...
										//if($_SESSION['ActiveUser']['activated'] != 1){
											?> 
												<script type="text/javascript">
													GB_showCenter('', 'http://sm0002.com/loginm', 180, 600);
												</script>
											<?
										//}
										// ---------------------------------------------------------
													...
													if($UnapprovedResult){
  													...
  													foreach($UnapprovedResult as $key => $value){
  														...
  														echo '<table><tr><td align="center">';
  															echo '<img src="http://sm0002.com/media/img_thumb/'.$key.'-'.$value['userid'].'.jpg" border="0">';
  															echo '</td></tr>';
        	...
        	case "member-ResendActivation-request":
                ...
                <script type="text/javascript">
                  function resendActivationEmail(){
                  	parent.parent.location="http://sm0002.com/ResendActivation";
                  }
                </script>
        	...
        	case "member-ProcessPaymentFeedback":
                ...
                <script type="text/javascript">
                  ...
                  function processPaymentSSL(){
                  	//parent.parent.location="https://sm0002.com/ProcessSubscriptionPayment";
                			...
                			<table style="width: 570px; height: 160px;" cellpadding="2" cellspacing="2" border="0" align="middle">
                				...
                				<tr>
                					<td align="center">
                						...
                						Processing Payment...
                						<br><br>
                						<img src="https://sm0002.com/common/img/progress_bar.gif" />
